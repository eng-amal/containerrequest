...
@extends('master')
@section('title',  __('contreq.pagename69'))
  ...
  <main class="main">
    ...
    <div >
      ...
      <div >
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="pull-left mb-2">
                    <h2 class="text-color">{{ __('contreq.pagename69') }}</h2>
                </div>
        ...
        @endif
        <form action="{{ route('storecar') }}" method="POST" enctype="multipart/form-data" class="form-group p-3 flex row">
            @csrf
                ...
                <div class="w-25 p-3">
                        ...
                        <input type="text" id="model" value="{{ old('model') }}" name="model" class="form-control" placeholder="{{ __('contreq.name') }}">
                        @error('model')
                    ...
                    <div class="w-25 p-3">
                        ...
                        <input class="form-control" dir="auto" type="text" id="no" value="{{ old('no') }}" name="no" class="form-control"  placeholder="{{ __('contreq.carno') }}">
                        @error('no')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="w-50 p-3">
                        ...
                        <select id="empid" class="form-select" name="empid" value="{{ old('empid') }}" class="form-control">
                         <option value="" selected="selected">{{ __('contreq.fullname') }}</option>
