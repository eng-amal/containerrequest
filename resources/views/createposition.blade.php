...
@extends('master')
@section('title',  __('contreq.pagename21'))
  ...
  <main class="main">
    ...
    <div >
      ...
      <div >
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="pull-left mb-2">
                    <h2 class="text-color">{{ __('contreq.pagename21') }}</h2>
                </div>
        ...
        @endif
        <form action="{{ route('storeposition') }}" method="POST" enctype="multipart/form-data" class="form-group p-3 flex row">
            @csrf      
                <div class="row flex">
                <div class="w-25 p-3">
