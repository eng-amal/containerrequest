@extends('master')
@section('title',  __('contreq.pagename92'))
@section('content')
...
<!-- Starter Section Section -->
    <section id="starter-section" class="starter-section section">
      ...
      <div class="pull-left mb-2">
        <h2 class="text-color">{{ __('contreq.pagename92') }}</h2>
      </div> 
            ...
            <tbody>
                @foreach ($maintinancerequests as $maintinancerequest)
                    <tr>
                        ...
                        <td>
                        <a class="btn" title="process" href="{{ route('maintinancerequestedit',$maintinancerequest->id) }}">
