...
@extends('master')
@section('title',  __('contreq.pagename51'))
  ...
  <main class="main">
    ...
    <div >
      ...
      <div >
        <div class="row">
            <div class="col-lg-12 margin-tb">
                <div class="pull-left mb-2">
                    <h2 class="text-color">{{ __('contreq.pagename51') }}</h2>
                </div>
                <div class="pull-right">
                    <a class="btn btn-primary" href="{{ route('cityindex') }}"> {{ __('contreq.back') }}</a>
                </div>
            </div>
        </div>
        ...
        @endif
        <form action="{{ route('storecity') }}" method="POST" enctype="multipart/form-data" class="form-group p-3 flex row">
            @csrf      
                <div class="row flex">
                <div class="w-25 p-3">
