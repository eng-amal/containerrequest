@extends('master')
@section('title',  __('contreq.pagename52'))
...
<!-- Starter Section Section -->
    <section id="starter-section" class="starter-section section">
      ...
      <div class="pull-left mb-2">
        <h2 class="text-color">{{ __('contreq.pagename52') }}</h2>
      </div> 
        ...
        <a class="btn" href="{{ route('createstreet',$city->id) }}">
            ...
            <tbody>
                @foreach ($streets as $street)
                    <tr>
                        ...
                        <td>{{ $street->enname }}</td>
                        <td>
                            <form action="{{ route('destroystreet',$street->id) }}" method="Post">
