@extends('master')
@section('title',  __('contreq.pagename67'))
...
<!-- Starter Section Section -->
    <section id="starter-section" class="starter-section section">
      ...
      <div class="pull-left mb-2">
        <h2 class="text-color">{{ __('contreq.pagename67') }}</h2>
      </div> 
        ...
        <a class="btn" href="{{ route('createnationality') }}">
            ...
            <tbody>
                @foreach ($nationalitys as $nationality)
                    <tr>
                        ...
                        <td>{{ $nationality->enname }}</td>
                        <td>
                            <form action="{{ route('destroynationality',$nationality->id) }}" method="Post">
