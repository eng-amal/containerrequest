@extends('master')
@section('title',  __('contreq.pagename59'))
...
<!-- Starter Section Section -->
    <section id="starter-section" class="starter-section section">
      ...
      <div class="pull-left mb-2">
        <h2 class="text-color">{{ __('contreq.pagename59') }}</h2>
      </div> 
        ...
        <a class="btn" href="{{ route('createbank') }}">
            ...
            <tbody>
                @foreach ($banks as $bank)
                    <tr>
                        ...
                        <td>{{ $bank->enname }}</td>
                        <td>
                            <form action="{{ route('destroybank',$bank->id) }}" method="Post">
