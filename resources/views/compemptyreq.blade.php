...
<main class="main">
      <div>
        ...
        @method('POST')
                    ...
                    <div class="w-25 p-3">
                        <strong>{{ __('contreq.emptydate') }}</strong>
                        <input type="date" name="emptydate" value="{{ $liftreq->emptydate }}" class="form-control" placeholder="emptydate">
                        @error('emptydate')
                        <div class="alert alert-danger mt-1 mb-1">{{ $message }}</div>
                        @enderror
                    </div>
